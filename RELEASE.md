...
[epic template]: https://github.com/conda/pycosat/issues/new?assignees=&labels=epic&template=epic.yml
[compare]: https://github.com/conda/pycosat/compare
[new release]: https://github.com/conda/pycosat/releases/new
...
[Anaconda Recipes]: https://github.com/AnacondaRecipes/pycosat-feedstock
[conda-forge]: https://github.com/conda-forge/pycosat-feedstock
...
Placeholder for `pycosat ` release.
...
[milestone]: https://github.com/conda/pycosat/milestone/<milestone>
[process]: https://github.com/conda/pycosat/blob/main/RELEASE.md
[releases]: https://github.com/conda/pycosat/releases
[main]: https://github.com/AnacondaRecipes/pycosat-feedstock
[conda-forge]: https://github.com/conda-forge/pycosat-feedstock
[ReadTheDocs]: https://readthedocs.com/projects/continuumio-pycosat/
...
- [ ] Ensure release candidates are being successfully built (see `conda-canary/label/rc-pycosat-`)
...
Once the release PRs are filed, successful canary builds will be available on `/pycosat/files?channel=rc-pycosat-` for manual testing.
...
2. Clone and `cd` into the repository if you haven't done so already:
    ...
    ```bash
    (rever) $ git clone git@github.com:/pycosat.git
    (rever) $ cd conda
    ```
